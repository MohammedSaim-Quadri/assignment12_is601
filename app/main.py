...
def update_calculation(
    ...
    type_changed = (calculation_update.type is not None and
                    calculation_update.type != calculation.type)
    
    if type_changed:
        old_id = calculation.id
        old_user_id = calculation.user_id
        old_created_at = calculation.created_at
        new_type = calculation_update.type
        ...
        try:
            ...
            new_calculation.id = old_id
            new_calculation.created_at = old_created_at
            new_calculation.updated_at = datetime.utcnow()
            new_calculation.result = new_calculation.get_result()
